...
template <> struct Traits<Machine>: public Traits<Machine_Common>
{
    ...
    static const unsigned int VECTOR_TABLE      = 0;//TODO
    static const unsigned int PAGE_TABLES       = 0;//TODO
    static const unsigned int MEM_TOP           = 0;//TODO
    static const unsigned int BOOT_STACK        = 0;//TODO
    ...
    static const unsigned int APP_LOW           = 0;//TODO
    static const unsigned int APP_CODE          = 0;//TODO
    static const unsigned int APP_DATA          = 0;//TODO
    ...
    static const unsigned int SYS_DATA          = 0;//TODO
    ...
    // PLL clocks
    static const unsigned int IO_PLL_CLOCK      = 0;//TODO
    static const unsigned int TIMER_CLOCK       = 0;//TODO
};
...
template <> struct Traits<IC>: public Traits<Machine_Common>
{
    ...
    static const unsigned int IRQS = 0;//TODO
    static const unsigned int INTS = 0;//TODO
};
